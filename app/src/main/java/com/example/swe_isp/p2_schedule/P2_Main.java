...
public class P2_Main extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(P2_Main.this,
                R.layout.p2_spinnerrow, R.id.spinner_id, programs);
        ...
        ArrayAdapter<String> y_arrayAdapter = new ArrayAdapter<String>(P2_Main.this,
                R.layout.p2_spinnerrow, R.id.spinner_id, years);
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                if(p.equals("Select Program") || y.equals("Select Year"))
                    new AlertDialog.Builder(P2_Main.this).
                    ...
                    sb.append("http://branko-cirovic.com/etcapp/timetables/timetable_"); sb.append(cid); sb.append(semester); sb.append(".xml");
                    loc = sb.toString();

                    Toast.makeText(P2_Main.this,"You Selected : "
